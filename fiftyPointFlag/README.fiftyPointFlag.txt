BZFlag Server Plugin: fiftyPointFlag
================================================================================
...
fiftyPointFlag directory to a new name, and then manually replace fiftyPointFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin fiftyPointFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin fiftyPointFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin fiftyPointFlag,<configfilename>
For example:
  -loadplugin fiftyPointFlag,/path/to/my/sampleplugin.cfg
